...
export default function CustomDataTable() {
    // Working on the pagination, moving from page 1 to 10
    const arr = [1,2,3,4,5]
    const PAGE_SIZE =10;
    const [currentPage, setCurrentPage] = useState(1);
    // an array of pages, start index=0 in an array
        ...
        <tbody>
            {
                ...
                {/* displaying the heading on each page */}
